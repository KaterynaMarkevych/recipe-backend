...
const RecipeDetail = ({ id, initialData = {} }) => {
  ...
  const [loading, setLoading] = useState(!initialData.recipe && !initialData.error);
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className="font-medium">{recipe.cuisine || 'Не вказано'}</div>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className="font-medium">{recipe.rating?.toFixed(1) || '0.0'}</div>
                </div>
              </div>
            </div>
            
            <div className="border-t border-gray-200 pt-6">
              <h3 className="text-lg font-medium mb-2">Харчова цінність (на порцію)</h3>
              <div className="grid grid-cols-4 gap-2">
                <div className="bg-gray-50 p-2 rounded-md text-center">
                  <div className="text-sm text-gray-500">Калорії</div>
                  <div className="font-medium">{recipe.nutrition?.calories || '0'} ккал</div>
                </div>
                
                <div className="bg-gray-50 p-2 rounded-md text-center">
                  <div className="text-sm text-gray-500">Білки</div>
                  <div className="font-medium">{recipe.nutrition?.protein || '0'} г</div>
                </div>
                
                <div className="bg-gray-50 p-2 rounded-md text-center">
                  <div className="text-sm text-gray-500">Жири</div>
                  <div className="font-medium">{recipe.nutrition?.fats || '0'} г</div>
                </div>
                
                <div className="bg-gray-50 p-2 rounded-md text-center">
                  <div className="text-sm text-gray-500">Вуглеводи</div>
                  <div className="font-medium">{recipe.nutrition?.carbs || '0'} г</div>
                </div>
              </div>
            </div>
          </div>
